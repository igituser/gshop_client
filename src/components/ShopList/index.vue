<template>
    <div class="home_shop_list">
        ...
        <div class="shop_container">
            <ul class="shop_list">
                <li @click="goShop" class="shop_li border-1px" v-for="(shop, index) in shops" :key="index">
                    <a>
                        <div class="shop_left">
                            <img class="shop_img" src="../../common/images/shop/brand_img.png">
                        </div>
